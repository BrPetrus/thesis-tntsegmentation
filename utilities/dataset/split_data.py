...
def main(input_folder: str, output_folder: str, padding: Tuple[int, int, int], overwrite_output_flag: bool = False) -> None:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--padding", type=int, nargs=3, metavar=("PAD_X", "PAD_Y", "PAD_Z"),
                        required=True, help="Padding for each axis (x, y, z) as three integers.")
